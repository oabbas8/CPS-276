...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'oabbas';//this will be your WCC username  
      $dbUsr = 'oabbas';//this will be your WCC username
      $dbPass = 'BqbuhdUW7w3W';//this will be the password found in the video.
